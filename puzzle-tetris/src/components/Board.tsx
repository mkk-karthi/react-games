...
export const Board = ({
  ...
  const containerClass = [
    'relative overflow-hidden rounded-xl border-2 border-cyan-400/30 bg-gradient-to-b from-blue-900/50 via-cyan-900/40 to-teal-900/50 shadow-bubble-glow sm:rounded-2xl',
    className ?? '',
  ]
    .filter(Boolean)
    .join(' ')
  ...
  return (
    <div className={containerClass}>
      ...
      <div className="relative grid aspect-[5/6] grid-cols-10 gap-[2px] p-3 sm:aspect-[5/6] sm:gap-[3px] sm:p-3">
        {grid.flatMap((row, y) =>
          row.map((cell, x) => {
