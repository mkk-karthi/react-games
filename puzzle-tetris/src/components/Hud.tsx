export const Hud = ({
  ...
  return (
    <div className="glass rounded-2xl border border-white/10 p-3 sm:p-5 shadow-glow">
      ...
      <div className="mt-2 sm:mt-4 grid grid-cols-1 gap-2 grid-cols-3">
        {stats.map((stat) => (
          <div
            key={stat.label}
            className={`rounded-xl border border-white/10 bg-gradient-to-br ${stat.accent} p-2 sm:p-3 text-center`}
          >
